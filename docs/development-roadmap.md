...
- [ ] **Complete address geocoding for volunteer home areas.** Resolve volunteer-entered postal/address data against an authoritative Singapore location source and derive planning area/neighbourhood. GE2025 electoral-division resolution is now implemented from the project-supplied boundary GeoJSON and runs automatically once verified coordinates are available.
