...
```text
src/app                    Web routes and authentication flow
...
src/types/database.ts      Initial generated-style Supabase types
...
The web application owns its authentication, content, attendance capture and staff handoff records, points, badges, and referrals. Attendance-based rewards will only be issued after the app reads a verified downstream YM Hub record in a later phase.
