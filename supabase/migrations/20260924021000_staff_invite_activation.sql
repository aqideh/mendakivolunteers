...
revoke all on function core.activate_current_staff_account()
  from public, anon, authenticated;
grant execute on function core.activate_current_staff_account()
  to authenticated, service_role;

create or replace function core.activate_staff_account_after_setup(
  p_user_id uuid
)
returns text
language plpgsql
...
revoke all on function core.activate_staff_account_after_setup(uuid)
  from public, anon, authenticated;
grant execute on function core.activate_staff_account_after_setup(uuid)
  to service_role;
